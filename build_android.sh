...
export MY_INCLUDES="$NDK_ROOT/sources/cxx-stl/gnu-libstdc++/4.6/include"
export MY_INCLUDES2="$NDK_ROOT/sources/cxx-stl/gnu-libstdc++/4.6/libs/armeabi/include"
export MY_LIBS="$NDK_ROOT/sources/cxx-stl/gnu-libstdc++/4.6/libs/armeabi"
