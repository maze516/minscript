...
#include "minipenv.h"			// fuer InterpreterValueType
#include "minparsernodes.h"		// fuer minVariableDeclarationList
...
class MINDLLEXPORT NativeFcnWrapperBase : public minNativeFcnInterface
{
public:
	NativeFcnWrapperBase( const string & sPrototype );
	virtual ~NativeFcnWrapperBase();

	virtual const string &						GetFunctionName() const { return m_sFcnName; }
	virtual int									GetFunctionTyp() const	{ return m_aVarList.size(); }
	virtual minInterpreterType					GetReturnType() const	{ return m_aReturnType; }
	virtual const minVariableDeclarationList &	GetArgumentList() const { return m_aVarList; }
...
public:
	...
	virtual minInterpreterValue operator()( minInterpreterValue & aParam1 )
	{
		...
		if( GetArgumentList()[0]->IsReference() )	// es gibt immer mindestens 1 Argument !!!
			aParam1 = aTmpParam1;
...
public:
	...
	virtual minInterpreterValue operator()( minInterpreterValue & aParam1, minInterpreterValue & aParam2 )
	{
		...
		// falls der Parameter mit call-by-reference uebergeben wurde, muss der Wert zurueckgeschrieben werden!
		if( GetArgumentList()[0]->IsReference() )
			aParam1 = aTmpParam1;
		if( GetArgumentList()[1]->IsReference() )
			aParam2 = aTmpParam2;
...
public:
	...
	virtual minInterpreterValue operator()( minInterpreterValue & aParam1, minInterpreterValue & aParam2, minInterpreterValue & aParam3 )
	{
		...
		if( GetArgumentList()[1]->IsReference() )
			aParam2 = aTmpParam2;
		if( GetArgumentList()[2]->IsReference() )
			aParam3 = aTmpParam3;
...
public:
	...
	virtual minInterpreterValue operator()( minInterpreterValue & aParam1, minInterpreterValue & aParam2, minInterpreterValue & aParam3, minInterpreterValue & aParam4 )
	{
		...
		if( GetArgumentList()[2]->IsReference() )
			aParam3 = aTmpParam3;
		if( GetArgumentList()[3]->IsReference() )
			aParam4 = aTmpParam4;
...
public:
	...
	virtual minInterpreterValue operator()( minInterpreterValue & aParam1, minInterpreterValue & aParam2, minInterpreterValue & aParam3, minInterpreterValue & aParam4, minInterpreterValue & aParam5 )
	{
		...
		if( GetArgumentList()[3]->IsReference() )
			aParam4 = aTmpParam4;
		if( GetArgumentList()[4]->IsReference() )
			aParam5 = aTmpParam5;
...
public:
											...
											minInterpreterValue & aParam6 )
	{
		...
		if( GetArgumentList()[4]->IsReference() )
			aParam5 = aTmpParam5;
		if( GetArgumentList()[5]->IsReference() )
			aParam6 = aTmpParam6;
...
public:
											...
											minInterpreterValue & aParam6, minInterpreterValue & aParam7 )
	{
		...
		if( GetArgumentList()[5]->IsReference() )
			aParam6 = aTmpParam6;
		if( GetArgumentList()[6]->IsReference() )
			aParam7 = aTmpParam7;
...
public:
											...
											minInterpreterValue & aParam6, minInterpreterValue & aParam7, minInterpreterValue & aParam8 )
	{
		...
		if( GetArgumentList()[6]->IsReference() )
			aParam7 = aTmpParam7;
		if( GetArgumentList()[7]->IsReference() )
			aParam8 = aTmpParam8;
...
public:
											...
											minInterpreterValue & aParam6, minInterpreterValue & aParam7, minInterpreterValue & aParam8, minInterpreterValue & aParam9 )
	{
		...
		if( GetArgumentList()[7]->IsReference() )
			aParam8 = aTmpParam8;
		if( GetArgumentList()[8]->IsReference() )
			aParam9 = aTmpParam9;
